    ...
    return (
        <header className={clsx("pb-4 pt-8 md:pb-8 md:pt-12 lg:pb-12", className)}>
            <div className="flex flex-col items-start gap-y-3 2xl:container">
                <h1 className="max-w-prose bg-gradient-to-tl from-black to-dark-faded bg-clip-text text-4xl font-bold leading-tight tracking-tighter text-transparent md:text-5xl">
                    {title}
                </h1>
